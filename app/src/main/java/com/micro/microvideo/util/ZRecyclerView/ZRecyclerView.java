...
import com.micro.microvideo.util.load.LineScalePulseOutIndicator;
...
public class ZRecyclerView extends RecyclerView {
    ...
    private Indicator mRefreshProgressStyle;
    private List<String> mRefreshText;
    private Indicator mLoadingMoreProgressStyle;
    ...
    private void init() {
        ...
        mLoadingMoreProgressStyle = new LineScalePulseOutIndicator();
    ...
    //判断是否是ZRecyclerView保留的itemViewType
    ...
    public void setRefreshProgressStyle(Indicator style) {
    ...
    public void setRefreshText(ArrayList<String> text) {
        mRefreshText = text;
        if (mRefreshHeader != null) {
            mRefreshHeader.setProgressText(text);
        }
    }

    public void setLoadingMoreProgressStyle(Indicator style) {
